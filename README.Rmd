...
2. Clone the repository to your local hard drive. On linux, using
...
is **not recommended**, however, since it does not reproduce the environment
...
enabled by [renv](https://rstudio.github.io/renv). If you want to build
...
[counts against the bandwidth limits of this repo](https://docs.github.com/en/github/managing-large-files/collaboration-with-git-large-file-storage),
and so may fail if these limits are exceeded. If you for some reason need
to do this and it fails, please file as issue here.
