...
singularity container will be published alongside the paper upon acceptance but
couldn't be included in the submission due to size constraints.
...
If you want to re-build the singularity container from scratch, you can do so by
navigating to the root of the repo and build the singularity container by
calling
...
Please do, however, first make sure that you've downloaded all of the datasets.
