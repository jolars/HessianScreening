...
#' @export
lassoPath <- function(X, y, family = "gaussian", standardize = TRUE, screening_type = "working", hessian_warm_starts = TRUE, approx_hessian = TRUE, path_length = 100L, maxit = 1e6L, tol_decr = 1e-4, tol_infeas = 1e-3, tol_gap = 1e-4, gamma = 0.01, verify_hessian = FALSE, verbosity = 0L) {
